...
class DependenciesValidator(
    private val dependencies: Map<String, DependencyValidator>,
) : JsonObjectValidator() {
...
sealed interface DependencyValidator {
     ...
     */
    fun validate(
        ksonObject: KsonObject,
        requiredBy: KsonObjectProperty,
        messageSink: MessageSink,
    )
}

data class DependencyValidatorArray(
    val dependency: Set<KsonString>,
) : DependencyValidator {
...
data class DependencyValidatorSchema(
