...
private class JsonTestData(private val rawTestName: String, val testSource: String, val filePath: String) {
    /**
...
${
        tests.joinToString("\n\n") {
            """
        |    /**
        |     * Test generated by [$generatorClassName] based on [y_array_empty-string.json in JSONTestSuite](file://${it.filePath})
        |     */
        |    @Test
        |""".trimMargin() + "    fun ${it.testName}() {\n" + "        assertParseResult(\n" + "            JsonParseResult.${it.parsingRequirement()},\n" + "            \"\"\"" + it.testSource + "\"\"\"\n" + "        )\n" + "    }"
        }
    }
}
