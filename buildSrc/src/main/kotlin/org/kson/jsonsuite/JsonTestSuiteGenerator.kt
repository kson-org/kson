...
private class JsonTestData(val rawTestName: String, val testSource: String, val filePath: String) {
    /**
...
${
        tests.joinToString("\n\n") {
            """
        |    /**
        |     * Test generated by [$generatorClassName] based on [${it.rawTestName} in JSONTestSuite](file://${it.filePath})
        |     */
        |    @Test
