 ...
 * that simplifies the file before passing it on to programming languages (for context, the
 * immediate trigger for creating [TinyCPreprocessor] was the inability of Python's CFFI library to load the original `kson.h`).
 *
