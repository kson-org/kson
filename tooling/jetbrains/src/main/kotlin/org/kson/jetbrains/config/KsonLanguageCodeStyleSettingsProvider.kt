...
class KsonLanguageCodeStyleSettingsProvider : LanguageCodeStyleSettingsProvider() {
    override fun getLanguage(): Language = KsonLanguage

    override fun getConfigurableDisplayName(): String = KsonLanguage.NAME
    ...
    ): CodeStyleConfigurable = KsonLanguageCodeStyleConfigurable(baseSettings, modelSettings)

    override fun createCustomSettings(settings: CodeStyleSettings): CustomCodeStyleSettings = KsonCodeStyleSettings(settings)
}

private class KsonCodeStyleMainPanel(
...
private class KsonLanguageCodeStyleConfigurable(
    ...
    override fun createPanel(settings: CodeStyleSettings): CodeStyleAbstractPanel = KsonCodeStyleMainPanel(currentSettings, settings)
}
